...
OBJS += cs225/HSLAPixel.o cs225/PNG.o cs225/lodepng/lodepng.o main.o Heatmap.o Bucket.o BFS.o ImageTraversal.o MapGraph.o GraphBFS.o
...
# Flags for compile:
CXXFLAGS += $(CS225) -std=c++14 -stdlib=libc++ -O2 $(WARNINGS) $(DEPFILE_FLAGS) -g -c
